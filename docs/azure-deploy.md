...
This guide is written so a human or agent can reproduce the deploy with Azure CLI. Exact resource names below are examples; pick **globally unique** ACR and storage account names when those collide.
